...
//Never delete this line!
	...
	private function ValidateConfiguration()
	{
		...
		$script_category = $this->ReadPropertyInteger("script_category");
		...
		} elseif ($script_category == 0) {
			$this->SetStatus(201); //Felder dürfen nicht leer sein
		} elseif ($ip !== "" && $script_category > 0 && (!filter_var($ip, FILTER_VALIDATE_IP) === false)) {
			$change = true;
			//$this->StartADB();
	...
	{
		$this->CreateFireTVScript("Fire TV Up", "FireTV_Up_Script", "Up");
		$this->CreateFireTVScript("Fire TV Down", "FireTV_Down_Script", "Down");
		$this->CreateFireTVScript("Fire TV Left", "FireTV_Left_Script", "Left");
		$this->CreateFireTVScript("Fire TV Right", "FireTV_Right_Script", "Right");
		$this->CreateFireTVScript("Fire TV Enter", "FireTV_Enter_Script", "Enter");
		$this->CreateFireTVScript("Fire TV Back", "FireTV_Back_Script", "Back");
		$this->CreateFireTVScript("Fire TV Home", "FireTV_Home_Script", "Home");
		$this->CreateFireTVScript("Fire TV Menu", "FireTV_Menu_Script", "Menu");
		$this->CreateFireTVScript("Fire TV Play", "FireTV_Play_Script", "Play");
		$this->CreateFireTVScript("Fire TV Previous", "FireTV_Previous_Script", "Previous");
		$this->CreateFireTVScript("Fire TV Next", "FireTV_Next_Script", "Next");
	}
	 ...
	 * @return int
	 */
	protected function CreateFireTVScript($Scriptname, $Ident, $Method)
	{
		...
		if ($ScriptID === false) {
			...
			$Script = '<?
FireTV_' . $Method . '(' . $this->InstanceID . ');		
?>';
	...
	{
		$startstring = shell_exec("adb shell dumpsys window windows | grep -E 'mCurrentFocus|mFocusedApp");
		return $startstring;
	}
